...
public class DMWebVideoView extends WebView {
    ...
    private final String mEmbedUrl = "http://www.dailymotion.com/embed/video/%s?html=1&fullscreen=true&app=%s&api=location";
    ...
    public void setVideoId(String videoId) {
        String formatted = String.format(mEmbedUrl, videoId, mAllowAutomaticNativeFullscreen, getContext().getPackageName());
        loadUrl(formatted);
    }
